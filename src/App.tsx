...
const style = { width: 300,backgroundColor: "white",borderRadius: 10, borderColor: "grey", borderWidth: 1, display: 'flex',justifyContent: 'space-between',alignItem: 'center',marginBottom: 10}
...
function PostComponent(){
  return(
    ...
    <div style={{fontSize: 14}}>𝐌𝐢𝐧𝐝 𝐁𝐥𝐨𝐰𝐧 𝐌𝐲 𝐀𝐈 𝐂𝐡𝐚𝐭 𝐉𝐮𝐬𝐭 𝐅𝐞𝐥𝐭 𝐇𝐮𝐦𝐚𝐧?
